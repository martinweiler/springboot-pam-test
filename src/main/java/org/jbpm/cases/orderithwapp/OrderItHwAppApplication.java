...
public class OrderItHwAppApplication {
    ...
    private static String GROUP_ID = "com.redhat.rhpam";//"itorders";
    private static String ARTIFACT_ID = "kjar-03356905";//"itorders";
    private static String VERSION = "2.0"; //"2.0.0"
	...
	public static void main(String[] args) {
        ...
        // System.out.println(releaseId.getArtifactId()+" is deployed...");
